...
<body>
    ...
    <div class="container mt-5">
        ...
        <p>This is your dashboard where you can manage your library activities.</p>
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Books</h5>
                        <p class="card-text">Manage the books in the library.</p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">View and manage borrowing transactions.</p>
